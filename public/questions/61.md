...
### 22.1 对应母题
Q62 Design Online Payment System（母题偏业务交易一致性）。
...
### 22.3 差异
1. Q61 面向云资源控制面，Q62 面向支付交易链路。
2. Q61 重点是调度与资源编排，Q62 重点是资金账务正确性。
3. Q61 更关注节点/可用区故障，Q62 更关注支付回调与对账。
...
### 22.5 面试话术
母题偏交易流程，本题是云基础设施控制平面；回答要突出“调度、迁移、计费、容量治理”的工程闭环。
